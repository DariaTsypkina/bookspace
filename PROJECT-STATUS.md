...
| 🔄 | `bd-707` | **Эпик DX: axios HTTP-клиент** (ADR 0005 accepted) — 3 / 10 · W1–W4 done (await close) |
...
План: [migration-axios.md](docs/tech/migration-axios.md). Сборочная: `feat/bookspace-bd-707`. W1–W4 (`bd-707.4`–`.7`) готовы к close.
